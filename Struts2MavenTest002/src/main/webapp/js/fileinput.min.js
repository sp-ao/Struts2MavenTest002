...
!function (e) {
    ...
    var i = function (e) {
        ...
        H = function (t, a) {
            var r = this;
            r.$element = e(t),
            r.validate() && (n() || i(9) ? (r.init(a), r.listen()) : r.$element.removeClass("file-loading"))
        };
    H.prototype = {
        abort: function (i) {
            var t,
        ...
        autoSizeImage: function (e) {
            ...
            o.length && o.on("load", function () {
                i = l.width(),
                t = r.width(),
                i > t && (o.css("width", "100%"), l.css("width", "97%")),
                a = o.closest(".file-preview-frame").find(".file-caption-name"),
                a.length && (a.width(o.width()), a.attr("title", a.text())),
        ...
        change: function (i) {
            ...
            if (a.resetErrors(), o = a.isUploadable ? a.getFileStack().length + r.length : r.length, a.maxFileCount > 0 && o > a.maxFileCount)
                return l             = a.msgFilesTooMany.repl("{m}", a.maxFileCount).repl("{n}", o), a.isError = g(l, null, null, null), a.$captionContainer.find(".kv-caption-icon").hide(), a.$caption.html(a.msgValidationError), a.setEllipsis(), void a.$container.removeClass("file-input-new file-input-ajax-new");
            if (!m || u && h > 0) {
                ...
                m && a.overwriteInitial && (a.clearPreview(), a.filestack = []);
            a.isIE9 ? a.updateFileDetails(1) : a.readFiles(r),
            a.showFolderError(v)
        },
        clear: function () {
            var i,
            ...
            a.resetErrors(!0),
            a.raise("fileclear"),
            !a.overwriteInitial && t.count(a.id) ? (a.showFileIcon(), a.resetPreview(), a.setEllipsis(), a.initPreviewDeletes(), a.$container.removeClass("file-input-new")) : (a.getThumbs().each(function () {
                a.clearObjects(e(this))
            }), a.$preview.html(""), i = !a.overwriteInitial && a.initialCaption.length > 0 ? a.initialCaption : "", a.setCaption(i), a.setEllipsis(), a.$caption.attr("title", ""), o(a.$container, "file-input-new")),
        ...
        clearFileInput: function () {
            var i,
                ...
                n = this,
                r = n.$element;
            R(r.val()) || (n.isIE9 || n.isIE10 ? (i = r.closest("form"), t = e(document.createElement("form")), a = e(document.createElement("div")), r.before(a), i.length ? i.after(t) : a.after(t), t.append(r).trigger("reset"), a.before(r).remove(), t.remove()) : r.val(""),
        ...
        init: function (n) {
            ...
            d.uploadFileAttr           = R(p.attr("name")) ? "file_data" : p.attr("name"),
            d.reader                   = null,
            d.formdata                 = {},
            d.isIE9                    = i(9),
            d.isIE10                   = i(10),
            ...
            R(d.$element.attr("id")) && d.$element.attr("id", B()),
            ...
            d.$captionContainer        = N(n, "elCaptionContainer", d.$container.find(".file-caption")),
            d.$caption                 = N(n, "elCaptionText", d.$container.find(".file-caption-name")),
            d.$previewContainer        = N(n, "elPreviewContainer", d.$container.find(".file-preview")),
            d.$preview                 = N(n, "elPreviewImage", d.$container.find(".file-preview-thumbnails")),
            d.$previewStatus           = N(n, "elPreviewStatus", d.$container.find(".file-preview-status")),
            d.$errorContainer          = N(n, "elErrorContainer", d.$previewContainer.find(".kv-fileinput-error")),
            R(d.msgErrorClass) || o(d.$errorContainer, d.msgErrorClass),
            d.$errorContainer.hide(),
            d.fileActionSettings       = e.extend(c, n.fileActionSettings),
            d.previewInitId            = "preview-" + B(),
        ...
        initDragDrop: function () {
            ...
            t.on("drop", function (t) {
                t.preventDefault(),
                i.isDisabled || (i.change(t, "dragdrop"), e(this).removeClass("highlighted"))
            }),
                ...
                r.off("click").on("click", function () {
                    l.fadeOut("slow", function () {
                        ...
                        var e = i.getFileStack(),
                            ...
                            s = t.count(i.id);
                        i.clearFileInput(),
                        0 === r && 0 === s ? i.reset() : (a     = s + r, n = a > 1 ? i.getMsgSelected(a) : e[0].name, i.setCaption(n))
                    })
                })
            }),
            ...
            i.$preview.find(".kv-file-remove").each(function () {
                ...
                if (!R(l) && void 0 !== s) {
                    var d,
                        ...
                        c,
                        u,
                        f = r.closest(".file-preview-frame"),
                        v = t.data[i.id],
                        h = f.data("fileindex");
                    h     = parseInt(h.replace("init_", "")),
                    c = R(v.config) && R(v.config[h]) ? null : v.config[h],
                    u = R(c) || R(c.extra) ? a : c.extra,
                    ...
                    d = e.extend({
                        beforeSend: function (e) {
                            i.ajaxAborted = !1,
                            i.raise("filepredelete", [
                                s, e, u
                            ]),
                            i.ajaxAborted ? e.abort() : (o(f, "file-uploading"), o(r, "disabled"))
                        },
                        data      : e.extend({
                            key: s
                        }, u),
                        ...
                        success   : function (e, a, l) {
                            var o,
                                d;
                            return void 0 !== e && void 0 !== e.error ? (p.jqXHR        = l, p.response = e, i.showError(e.error, p, "filedeleteerror"), f.removeClass("file-uploading"), r.removeClass("disabled"), void n()) : (t.unset(i.id, h), o = t.count(i.id), d = o > 0 ? i.getMsgSelected(o) : "", i.raise("filedeleted", [
                                s, l, u
                            ]), i.setCaption(d), f.removeClass("file-uploading").addClass("file-deleted"), void f.fadeOut("slow", function () {
                                i.clearObjects(f),
                                f.remove(),
                                n(),
        ...
        initThumbDelete: function (e) {
            ...
            e.find(".kv-file-remove").removeAttr("disabled").off("click").on("click", function () {
                var t = i.raise("filesuccessremove", [
                    e.attr("id"), e.data("fileindex")
                ]);
        ...
        previewDefault: function (i, t, a) {
            if (this.showPreview) {
                var n = this,
                    ...
                    c = "";
                a === !0 && (c     = " btn disabled", s += '<div class="file-other-error text-danger"><i class="glyphicon glyphicon-exclamation-sign"></i></div>'),
                n.$preview.append("\n" + d.repl("{previewId}", t).repl("{frameClass}", c).repl("{fileindex}", p).repl("{caption}", n.slug(i.name)).repl("{width}", o.width).repl("{height}", o.height).repl("{type}", i.type).repl("{data}", r).repl("{footer}", s)),
                l.on("load", function () {
        ...
        raise: function (i, t) {
            var a = this,
                n = e.Event(i);
            if (void 0 !== t ? a.$element.trigger(n, t) : a.$element.trigger(n), !n.result)
                return !1;
            switch (i) {
        ...
        readFiles: function (i) {
            function t(e) {
                ...
                F = F.toFixed(2),
                a.maxFileSize > 0 && F > a.maxFileSize)
                    return b = a.msgSizeTooLarge.repl("{name}", k).repl("{size}", F).repl("{maxSize}", a.maxFileSize), void(a.isError = h(b, E, T, e));
                if (!R(P) && z(P)) {
                    for (w = 0; w < P.length; w += 1)
                        C     = P[w],
                        g = f[C],
                        x = void 0 !== g && g(E.type, k),
                        I += R(x) ? 0 : x.length;
                    if (0 === I)
                        return b = a.msgInvalidFileType.repl("{name}", k).repl("{types}", S), void(a.isError = h(b, E, T, e))
                }
                return 0 !== I || R(U) || !z(U) || R($) || (x = k.match($), I += R(x) ? 0 : x.length, 0 !== I) ? a.showPreview ? (r.length > 0 && void 0 !== FileReader ? (s.html(d.repl("{index}", e + 1).repl("{files}", u)), o.addClass("loading"), l.onerror = function (e) {
                    ...
                    a.previewFile(E, e, T, D),
                    a.initFileActions()
                }, l.onloadend = function () {
                    b = p.repl("{index}", e + 1).repl("{files}", u).repl("{percent}", 50).repl("{name}", k),
                    setTimeout(function () {
                        s.html(b),
                        q.revokeObjectURL(D)
                    }, 100),
                    ...
                    if (i.lengthComputable) {
                        var t = i.loaded / i.total * 100,
                            a = Math.ceil(t);
                        b = p.repl("{index}", e + 1).repl("{files}", u).repl("{percent}", a).repl("{name}", k),
                        setTimeout(function () {
                            s.html(b)
                        }, 100)
                    }
                    ...
                    t(e + 1),
                    a.updateFileDetails(u)
                }, 100), a.raise("fileloaded", [
                    E, T, e, l
                ])),
                void a.filestack.push(E)) : (a.filestack.push(E), setTimeout(t(e + 1), 100), void a.raise("fileloaded", [
                    E, T, e, l
                ])) : (b = a.msgInvalidFileExtension.repl("{name}", k).repl("{extensions}", j), void(a.isError = h(b, E, T, e)))
            }
        ...
        renderUpload: function () {
            ...
            t = !e.isUploadable || e.isDisabled ? '<button type="submit" title="' + e.uploadTitle + '"class="' + i + '"' + a + "' onclick='displayMask(); return true;'>" + e.uploadIcon + e.uploadLabel + "</button>" : '<a href="' + e.uploadUrl + '" title="' + e.uploadTitle + '" class="' + i + '"' + a + ">" + e.uploadIcon + e.uploadLabel + "</a>") : ""
        },
        reset: function () {
            var e = this;
            e.clear(),
        ...
        updateFileDetails: function (e) {
            ...
            1 === arguments.length && i.raise("fileselect", [
                e, l
            ]),
        ...
        uploadBatch                   : function () {
            ...
            0 !== d && p && !l.abort(c) && (i     = function () {
                ...
                l.showPreview && l.getThumbs().each(function () {
                    ...
                    i.hasClass("file-preview-success") || (l.setThumbStatus(i, "Loading"), o(i, "file-uploading")),
                    t.attr("disabled", !0),
                    a.attr("disabled", !0)
                }),
                ...
                l.showUploadError(t.error, r, "filebatchuploaderror"))
            }, n = function () {
                l.setProgress(100),
                l.unlock(),
                l.raise("filebatchuploadcomplete", [
                    l.filestack, l.getExtraData()
                ]),
                l.clearFileInput()
            }, r = function (i, t, a) {
        ...
        uploadExtraOnly               : function () {
            ...
            n.abort(r) || (e = function (e) {
                ...
                n.setProgress(100),
                n.unlock(),
                n.raise("filebatchuploadcomplete", [
                    n.filestack, n.getExtraData()
                ]),
                n.clearFileInput()
            }, a = function (e, i, t) {
        ...
        uploadSingle: function (i, a, n) {
            ...
            h.formdata = g,
            0 === m || !y || C.hasClass("disabled") || h.abort(T) || (s     = function () {
                var e = h.getThumbs(".file-uploading");
                e.length > 0 || h.fileBatchCompleted || (h.fileBatchCompleted = !0, setTimeout(function () {
                    t.set(h.id, h.uploadCache.content, h.uploadCache.config, h.uploadCache.tags, h.uploadCache.append),
                    h.hasInitData && (h.initPreview(), h.initPreviewDeletes()),
                    h.setProgress(100),
                    h.unlock(),
                    h.clearFileInput(),
                    h.raise("filebatchuploadcomplete", [
                        h.filestack, h.getExtraData()
                    ])
                }, 100))
            }, d = function () {
                ...
                r = h.getOutData(t),
                b.hasClass("file-preview-success") || (h.setThumbStatus(b, "Loading"), o(b, "file-uploading")),
                C.attr("disabled", !0),
                x.attr("disabled", !0),
                n || h.lock(),
                h.raise("filepreupload", [
                    r, w, i
                ]),
                T = e.extend(T, r),
                h.abort(T) && (t.abort(), h.setProgress(100))
            }, u = function (t, a, l) {
                r     = h.getOutData(l, t),
                T = e.extend(T, r),
                setTimeout(function () {
                    void 0 === t.error ? (h.setThumbStatus(b, "Success"), C.hide(), h.initThumbDelete(b), h.filestack[i] = void 0, h.raise("fileuploaded", [
                        r, w, i
                    ]), h.initUploadSuccess(t, b, n), n || h.resetFileStack()) : (h.setThumbStatus(b, "Error"), h.showUploadError(t.error, T))
                }, 100)
            }, f = function () {
                setTimeout(function () {
                    d(),
                ...
                h.setThumbStatus(b, "Error"),
                T = e.extend(T, h.getOutData(t)),
                h.showUploadError(o, T)
    ...
    e.fn.fileinput             = function (t) {
        if (n() || i(9)) {
            ...
            return a.shift(), this.each(function () {
                ...
                r || (i = e.extend({}, e.fn.fileinput.defaults), "en" === o || R(e.fn.fileinputLocales[o]) || (i = e.extend(i, e.fn.fileinputLocales[o])), r = new H(this, e.extend(i, l, n.data())), n.data("fileinput", r)),
    ...
    e.fn.fileinputLocales.en   = {
        ...
        msgInvalidFileExtension: '拡張子エラー "{name}". "{extensions}" の拡張子のみアップロード出来ます.',
        msgInvalidFileType     : 'Invalid type for file "{name}". Only "{types}" files are supported.',
        msgLoading             : "Loading file {index} of {files} &hellip;",
        msgProgress            : "Loading file {index} of {files} - {name} - {percent}% completed.",
        msgSelected            : "{n} {files} selected",
        msgSizeTooLarge        : 'File "{name}" (<b>{size} KB</b>) ｱｯﾌﾟﾛｰﾄﾞ出来るﾌｧｲﾙｻｲｽﾞは <b>{maxSize} KB</b>までです ﾌｧｲﾙｻｲｽﾞを小さくしてｱｯﾌﾟﾛｰﾄﾞしてください',
        msgValidationError     : "File Upload Error",
        removeLabel            : "ｸﾘｱ",
        removeTitle            : "選択したﾌｧｲﾙをｸﾘｱ",
        uploadLabel            : "ｱｯﾌﾟﾛｰﾄﾞ",
        uploadTitle            : "選択したﾌｧｲﾙをｱｯﾌﾟﾛｰﾄﾞ"
    },
